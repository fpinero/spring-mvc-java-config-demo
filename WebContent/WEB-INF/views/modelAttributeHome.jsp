...
<body>
	<div align="left">
		...
		<hr/>
		<!-- form spring tag in action -->
		<form:form action="test5" modelAttribute="anAddress">
			<h3>test 5: Testing @ModelAttribute annotation with 'value' attribute and default bidding</h3>
			<table>
				<tr>
				...
				<tr>
					<td><form:label path="zipCode">City Name</form:label></td>
		...
		<form:form action="modelAttributeTest">
			...
			<table>
				<tr>
					<td><input type="submit" value="Relocate"/>
				</tr>
			</table>
		</form:form>
	</div>
