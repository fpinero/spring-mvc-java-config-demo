...
public class RequestMappingAndParamDemoController {
	...
	// test1: Testing @RequestParam without explict attributes
	...
	@RequestMapping(value = "*", method = RequestMethod.GET) // * = cualquier
																// request a una
																// url q no este
																// definida
																// anteriormente
	...
	public String requestMappingAndParamTest4(
			@RequestParam(value = "orgname", defaultValue = "Organización Anónima") String orgName, Model model) {
		model.addAttribute("orgname", orgName);
	...
	// test 5: Testing @RequestParam without 'name' ot 'value' attribute
	...
	// test 6: subtest 1 testing removal of @RequestMapping @RequestMapping
	// ambiguity
	...
	// test 6: subtest 3 testing removal of @RequestMapping with multiple params
